...
class AppLocalizationsUk extends AppLocalizations {
  ...
  @override
  String get ambientMode => 'Режим спокою';

  @override
  String get ambientModeInfo =>
      'Мінімалістичний інтерфейс з високою контрастністю, який тримає екран увімкненим під час роботи таймера. Ідеально підходить для використання за столом.';
  ...
  String get termsAndConditionsIntro =>
      'Ласкаво просимо до Pomozen. Ці умови регулюють використання нашого застоункового продуктивності. 🙏';
